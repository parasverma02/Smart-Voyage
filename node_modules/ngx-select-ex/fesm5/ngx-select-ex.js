...
import { Directive, TemplateRef, InjectionToken, Input, Output, ViewChild, ElementRef, ContentChild, HostListener, Component, ChangeDetectionStrategy, forwardRef, Inject, Optional, IterableDiffers, ChangeDetectorRef, EventEmitter, NgModule } from '@angular/core';
import { CommonModule } from '@angular/common';
import { NG_VALUE_ACCESSOR } from '@angular/forms';
import { DomSanitizer } from '@angular/platform-browser';
import { of, from, EMPTY, BehaviorSubject, Subject, combineLatest, merge } from 'rxjs';
import { flatMap, filter, toArray, tap, map, distinctUntilChanged, share } from 'rxjs/operators';
...
var NgxSelectComponent = /** @class */ (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", NgxSelectOptionDirective)
    ...
    __decorate([
        ...
        __metadata("design:type", NgxSelectOptionSelectedDirective)
    ...
    __decorate([
        ...
        __metadata("design:type", NgxSelectOptionNotFoundDirective)
    ...
    NgxSelectComponent = NgxSelectComponent_1 = __decorate([
        ...
        __metadata("design:paramtypes", [IterableDiffers, DomSanitizer, ChangeDetectorRef, Object])
    ], NgxSelectComponent);
