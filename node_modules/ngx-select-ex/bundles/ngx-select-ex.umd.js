    ...
    ***************************************************************************** */
    ...
    var NgxSelectComponent = /** @class */ (function () {
        function NgxSelectComponent(iterableDiffers, sanitizer, cd, defaultOptions) {
            ...
            rxjs.combineLatest(this.subjOptions.pipe(operators.flatMap(function (options) { return rxjs.from(options).pipe(operators.flatMap(function (option) { return option instanceof NgxSelectOption
                ? rxjs.of(option)
                : (option instanceof NgxSelectOptGroup ? rxjs.from(option.options) : rxjs.EMPTY); }), operators.toArray()); })), subjActualValue).pipe(operators.map(function (_a) {
        ...
        __decorate([
            core.ViewChild('choiceMenu', { static: false }),
            __metadata("design:type", core.ElementRef)
        ...
        NgxSelectComponent = NgxSelectComponent_1 = __decorate([
            ...
            __metadata("design:paramtypes", [core.IterableDiffers, platformBrowser.DomSanitizer, core.ChangeDetectorRef, Object])
        ], NgxSelectComponent);
